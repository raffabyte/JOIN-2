                ...
                <div class="flexR task-form-top">
                    ...
                    <div class="flexC task-form-column">
                        ...
                        <div class="flexR priority-select">
                            <button type="button" class="priority-button flexR HighPriority" id="priorityHigh" onclick="PriorityHandler('high'); event.stopPropagation();">
                            ...
                            <button type="button" class="priority-button flexR MidPriority" id="priorityMedium" onclick="PriorityHandler('medium'); event.stopPropagation();">
                            ...
                            <button type="button" class="priority-button flexR LowPriority" id="priorityLow" onclick="PriorityHandler('low'); event.stopPropagation();">
                        ...
                        <select id="taskAssignee" name="taskAssignee">
                            ...
                            <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.54854 4.3L0.948535 1.7C0.631868 1.38333 0.561035 1.02083 0.736035 0.6125C0.911035 0.204167 1.22354 0 1.67354 0H6.82354C7.27354 0 7.58603 0.204167 7.76103 0.6125C7.93604 1.02083 7.8652 1.38333 7.54853 1.7L4.94854 4.3C4.84854 4.4 4.7402 4.475 4.62354 4.525C4.50687 4.575 4.38187 4.6 4.24854 4.6C4.1152 4.6 3.9902 4.575 3.87354 4.525C3.75687 4.475 3.64854 4.4 3.54854 4.3Z" fill="#2A3647"/>
                            </svg>
                        ...
                        <input class="inputs" type="text" id="subtasks" name="subtasks">
                    </div>
                </div>
